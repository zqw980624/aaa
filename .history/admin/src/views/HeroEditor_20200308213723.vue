  ...
  <div>
    ...
    <el-form @submit.native.prevent="save" label-width="100px">
      ...
      <el-form-item label="难度">
        <el-rate style="margin-top:.6rem" :max="9" v-model="model.details.difficulty" show-score></el-rate>
      </el-form-item>
      <el-form-item label="技能">
        <el-rate style="margin-top:.6rem" v-model="model.details.skill" show-score></el-rate>
      </el-form-item>
      <el-form-item label="攻击">
        <el-rate style="margin-top:.6rem" v-model="model.details.attack" show-score></el-rate>
      </el-form-item>
      <el-form-item label="生存">
        <el-rate style="margin-top:.6rem" v-model="model.details.existence" show-score></el-rate>
      </el-form-item>
