  ...
  <div>
    ...
    <el-form @submit.native.prevent="save" label-width="100px">
      ...
      <el-form-item label="使用技巧">
        <el-input model="model.useTip" type="textarea"></el-input>
      </el-form-item>
       <el-form-item label="对抗技巧">
        <el-input model="model.combatTip" type="textarea"></el-input>
      </el-form-item>
       <el-form-item label="团队思路">
        <el-input model="model.teamTip" type="textarea"></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async fetch() {
      let res = await this.$http.get(`/rest/heroest/${this.id}`);
