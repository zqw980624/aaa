...
<template>
  <el-container style="height: 100vh; border: 1px solid #eee">
    <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
      <el-menu router :default-active="$route.path" :default-openeds="['1']" unique-opened background-color="#404040" text-color="#aaa" active-text-color="#ff4238">
        <el-submenu index="1">
          <template slot="title">
        ...
        <el-submenu index="2">
         ...
         <el-submenu index="3">
           ...
           <el-menu-item-group>
            ...
            <el-menu-item index="/ad/create">新建管理员</el-menu-item>
            <el-menu-item index="/ad/list">管理员列表</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
      </el-menu>
    </el-aside>
