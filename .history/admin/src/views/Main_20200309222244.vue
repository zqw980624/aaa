...
<template>
  <el-container style="height: 100vh; border: 1px solid #eee">
    <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
      <el-menu router :default-active="$router.path" :default-openeds="['1']" unique-opened background-color="#404040" text-color="#aaa" active-text-color="#ff4238">
        <el-submenu index="1">
          <template slot="title">
            <i class="el-icon-message"></i>内容管理{{$router.path}}1111
          </template>
          <el-menu-item-group>
