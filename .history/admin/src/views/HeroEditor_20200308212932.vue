  ...
  <div>
    ...
    <el-form @submit.native.prevent="save" label-width="100px">
      ...
      <el-form-item label="难度">
        <el-rate v-model="details.difficulty" show-score></el-rate>
      </el-form-item>
      <el-form-item label="技能">
        <el-rate v-model="details.skill" show-score></el-rate>
      </el-form-item>
      <el-form-item label="攻击">
        <el-rate v-model="details.attack" show-score></el-rate>
      </el-form-item>
      <el-form-item label="生存">
        <el-rate v-model="details.existence" show-score></el-rate>
      </el-form-item>
